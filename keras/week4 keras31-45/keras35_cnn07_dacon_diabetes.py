...
#2. 모델구성
model = Sequential()
model.add(Conv2D(50, (2,1), input_shape= (5,2,1), padding='same' ))
...
hist = model.fit(x_train, y_train, callbacks=[mcp,es], epochs= 1000, batch_size = 1, validation_split= 0.3)
end_time = time.time()
...
# plt.rcParams['font.family'] = 'Malgun Gothic'dd
...
#cnn
#로스 : [2672.201416015625, 0.0]
# R2 스코어 : 0.5917464270028028
# 걸린 시간 : 58.04 초