...
x= x.reshape(5497,3,4,1)
test_csv= test_csv.reshape(1000,3,4,1)
...
model = Sequential()
model.add(Conv2D(50, (2,2), input_shape=(3,4,1)))
...
hist = model.fit(x_train, y_train, callbacks=[mcp,es], epochs= 1000, batch_size = 10, validation_split= 0.4)
end_time = time.time()
