...
es = EarlyStopping(monitor = 'val_loss', mode = 'min', patience = 40, verbose = 0, restore_best_weights= True)
...
hist = model.fit(x_train, y_train, callbacks=[es,mcp], epochs= 2000, batch_size = 500, validation_split= 0.2)
