...
#2. 모델구성
model = Sequential()
model.add(Conv1D(5, kernel_size=2, input_shape = (10,1)))
model.add(Flatten())
model.add(Dense(12))
...
hist = model.fit(x_train, y_train, callbacks=[mcp], epochs= 1000, batch_size = 5, validation_split= 0.3)
end_time = time.time()
...
#LSTM
# 로스 : [3901.8076171875, 0.0]
# R2 스코어 : 0.4038895621841392

#Conv1D
#로스 : [2887.02734375, 0.0]
#R2 스코어 : 0.5589257005811025
