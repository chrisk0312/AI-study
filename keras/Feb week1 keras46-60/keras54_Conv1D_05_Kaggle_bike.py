...
#2. 모델구성
model = Sequential()
model.add(Conv1D(1024, kernel_size=2, input_shape = (8,1)))
model.add(Flatten())
model.add(Dense(512,))
model.add(Dense(256,))
...
hist = model.fit(x_train, y_train, callbacks=[es,mcp], epochs= 10000, batch_size = 100, validation_split= 0.27)
end_time = time.time()
...
#LSTM
# RMSE :  201.71937710275137
# RMSLE : 1.2048967308112009


#Conv1D
# RMSE :  202.91554435448384
# RMSLE : 1.2843749324320826