...
from keras.layers import Dense,LSTM, Conv2D, Flatten, Dropout, MaxPooling2D, AveragePooling2D, BatchNormalization
...
model = Sequential()
model.add(LSTM(30, input_shape = (96,32), activation= 'relu'))
