...
# es = EarlyStopping(monitor = 'val_loss', mode = 'min', patience = 500, verbose = 0, restore_best_weights= True)
# mcp = ModelCheckpoint(monitor='val_loss', mode = 'auto', verbose= 1, save_best_only=True, filepath='../_data/_save/MCP/keras26_06_MCP.hdf5')
