...
model = Sequential()
model.add(Conv1D(100, kernel_size=2, input_shape = (12,1)))
model.add(Flatten())
model.add(Dense(90))
model.add(Dense(80))
...
hist = model.fit(x_train, y_train, callbacks=[mcp], epochs= 1000, batch_size = 10, validation_split= 0.4)
end_time = time.time()
...
#LSTM
#로스 : 4.959591388702393
#acc : 0.5918181818181818