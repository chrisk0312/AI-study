...
x_test= mms.transform(x_test).reshape(x_test.shape[0],6,5,1)


#2. 모델구성

model = Sequential()
model.add(Conv2D(32,(2,2), input_shape = (6,5,1), activation='relu'))
...
model.compile(loss= 'binary_crossentropy', optimizer= 'adam' ) #mae 2.64084 r2 0.8278   mse 12.8935 r2 0.82
