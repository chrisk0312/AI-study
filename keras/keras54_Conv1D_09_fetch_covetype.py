...
model = Sequential()
model.add(Conv1D(128, input_shape = (54,1)))
model.add(Flatten())
...
his = model.fit(x_train, y_train, epochs= 10000, batch_size=10000, validation_split= 0.25, verbose=2, ) #검증모델은 간접적인 영향을 미침.
end_time = time.time()
...
#LSTM
#로스 : 0.23824799060821533
#acc : 0.9062213144850376

#Conv1D
# 로스 : 0.3651975691318512
# 정확도 : 0.8422985076904297
