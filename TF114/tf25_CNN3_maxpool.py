...
w1 = tf.compat.v1.get_variable('w1',shape=[2,2,1,128])# [kernal_width,kernal_height,channel,filter]
...
# flatten = m2.set_shape([m2.shape[0],m2.shape[1]*m2.shape[2]*m2.shape[3]])
