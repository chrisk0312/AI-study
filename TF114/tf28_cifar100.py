...
w4 = tf.compat.v1.get_variable('w4',shape=[flatten.shape[1],1000])
b4 = tf.compat.v1.Variable(tf.zeros([1000]),name='b4')
d1 = tf.nn.relu(tf.matmul(flatten,w4) + b4)
print("d1",d1)

dr3 = tf.nn.dropout(d1,rate=0.01)

w5 = tf.compat.v1.get_variable('w5',shape=[1000,100])
