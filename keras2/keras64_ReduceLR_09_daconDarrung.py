...
input = Input(shape=(9,))
d1 = Dense(512, activation='sigmoid')(input)
drop1 = Dropout(0.2)(input)
d2 = Dense(512, activation='relu')(drop1)
d3 = Dense(256, activation='relu')(d2)
d4 = Dense(256, activation='relu')(d3)
drop2 = Dropout(0.5)(d4)
...
reduceLR = ReduceLROnPlateau(monitor='val_loss',mode='auto',patience=100,factor=0.5,verbose=1)
