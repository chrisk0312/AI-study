...
train_meta = pd.read_csv('C:\_data\\ai_factory\dataset\\train_meta.csv') # train 데이터 meta 정보
test_meta = pd.read_csv('C:\_data\\ai_factory\dataset\\test_meta.csv') # test 데이터 meta 정보


# 저장 이름
save_name = 'base_line4'
...
RANDOM_STATE = 300 # seed 고정
INITIAL_EPOCH = 0 # 초기 epoch

# 데이터 위치
IMAGES_PATH = 'C:\_data\\ai_factory\dataset\\train_img/'        #
MASKS_PATH = 'C:\_data\\ai_factory\dataset\\train_mask/'        #

# 가중치 저장 위치
OUTPUT_DIR = 'C:\_data\\ai_factory\dataset//train_output//'     #
WORKERS = 4
...
for i in test_meta['test_img']:
    img = get_img_762bands(f'C:\_data\\ai_factory\dataset\\test_img//{i}')
...
joblib.dump(y_pred_dict, 'C:\_data\\ai_factory\dataset//train_output/0325_1.pkl')         